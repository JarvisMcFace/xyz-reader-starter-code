...
//    private static final float PARALLAX_FACTOR = 1.25f;
   ...
   // private View mPhotoContainerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) getActivity().findViewById(R.id.details_toolbar);
    ...
    private void updateStatusBar() {
        int color = 0;
        if (photoView != null && mTopInset != 0 && mScrollY > 0) {
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            derivePublishAuthorDate(bylineView, publishedDate);
            ...
            ImageLoaderHelper.getInstance(getActivity()).getImageLoader().get(mCursor.getString(ArticleLoader.Query.PHOTO_URL), new ImageLoader.ImageListener() {
                        ...
                        public void onResponse(ImageLoader.ImageContainer imageContainer, boolean b) {
                            ...
                            if (bitmap != null) {
                                ...
                                getActivity().findViewById(R.id.meta_bar).setBackgroundColor(mMutedColor);
    ...
    private void derivePublishAuthorDate(TextView bylineView, Date publishedDate) {
       ...
       String author=  mCursor.getString(ArticleLoader.Query.AUTHOR);
        if (!publishedDate.before(START_OF_EPOCH.getTime())) {
            ...
            bylineView.setText(Html.fromHtml(outputFormat.format(publishedDate) + " by <font color='#ffffff'>"
                    + author
                    + "</font>"));
...
//    public int getUpButtonFloor() {
//        if (mPhotoContainerView == null || photoView.getHeight() == 0) {
//            return Integer.MAX_VALUE;
//        }
//
//        // account for parallax
//        return mIsCard
//                ? (int) mPhotoContainerView.getTranslationY() + photoView.getHeight() - mScrollY
